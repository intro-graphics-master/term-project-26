...
let body_transform = spiderman_transform.times(Mat4.translation([-7, 10, -10]));
body_transform = body_transform.times(Mat4.scale([0.5, 0.5, 0.5]));

var width = 16, height = 20, depth = 3;
...
for(let x = 0; x < width; x++) {
    ...
    for(let y = 0; y < height; y++) {
        ...
        for(let z = 0; z < depth; z++) {
            ...
            box_array[x][y][z] = new Box(true, Color.of(1, 0, 0, 1), translated_transform, 0.5);
        }
    }
}
